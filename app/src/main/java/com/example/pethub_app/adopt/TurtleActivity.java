...
public class TurtleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(connection){
                    ...
                    Toast.makeText(TurtleActivity.this,"Internet Connection Error!",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(TurtleActivity.this,1);
        ...
        final MyAdapter myAdapter = new MyAdapter(TurtleActivity.this, myPetList);
        mRecyclerView.setAdapter(myAdapter);

        dRef = FirebaseDatabase.getInstance().getReference("PetData").child("Turtle");
        pd.show();
