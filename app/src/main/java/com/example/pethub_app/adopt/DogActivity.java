...
public class DogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(connection){
                    ...
                    Toast.makeText(DogActivity.this,"Internet Connection Error!",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(DogActivity.this,1);
        ...
        final MyAdapter myAdapter = new MyAdapter(DogActivity.this, myPetList);
        mRecyclerView.setAdapter(myAdapter);

        dRef = FirebaseDatabase.getInstance().getReference("PetData").child("Dog");
        pd.show();
