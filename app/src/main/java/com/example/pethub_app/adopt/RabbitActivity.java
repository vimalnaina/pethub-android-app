...
public class RabbitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(connection){
                    ...
                    Toast.makeText(RabbitActivity.this,"Internet Connection Error!",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(RabbitActivity.this,1);
        ...
        final MyAdapter myAdapter = new MyAdapter(RabbitActivity.this, myPetList);
        mRecyclerView.setAdapter(myAdapter);

        dRef = FirebaseDatabase.getInstance().getReference("PetData").child("Rabbit");
        pd.show();
